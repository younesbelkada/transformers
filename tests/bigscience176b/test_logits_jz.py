...
class BigScienceEmbeddingTest(unittest.TestCase):
    ...
    def test_logits(self):
        ...
        torch.save(logits, "/gpfswork/rech/six/uan68tv/data/tensors_to_test/logits_1_tr_apex_layerfixed.pt")
        ...
        logits = model(input_tensor, attention_mask=ATTN_MASK).logits
        torch.save(logits, "/gpfswork/rech/six/uan68tv/data/tensors_to_test/logits_2_tr_apex_layerfixed.pt")
