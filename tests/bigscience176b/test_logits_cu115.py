...
input_linear_tr = os.path.join(path_tr_logits, "context_layer_after_1.pt", map_location=device)
input_linear_mgs = os.path.join(path_meg_logits, "input_row_mlp_rank_0.pt", map_location=device)

weight_tr = os.path.join(path_tr_logits, "dense_weight_1.pt", map_location=device)
weight_meg = os.path.join(path_meg_logits, "weight_mlp_rank_0.pt", map_location=device)

output_tr = os.path.join(path_tr_logits, "output_attn_layer_1.pt", map_location=device)
output_meg = os.path.join(path_meg_logits, "output_layer_1_rank_0.pt", map_location=device)
