...
path_meg_logits = "/gpfswork/rech/six/uan68tv/data/tensors_to_test/logits_parallel_rank_0.pt"
path_tr_logits = "/gpfswork/rech/six/uan68tv/data/tensors_to_test/logits_1_tr_apex_cu115.pt"
...
meg_logits = torch.load(path_meg_logits, map_location=device)
tr_logits = torch.load(path_tr_logits, map_location=device)
