...
class CogVlmVisionText2TextModelTester:
    def __init__(
        self,
        parent,
        ignore_index=-100,
...
@require_torch
class CogVlmForConditionalGenerationModelTest(ModelTesterMixin, unittest.TestCase):
    """
    Model tester for `CogVlmForConditionalGeneration`.
    """
    ...
    def setUp(self):
        self.model_tester = CogVlmVisionText2TextModelTester(self)
        self.config_tester = ConfigTester(self, config_class=CogVlmConfig, has_text_modality=False)
...
@require_torch
class CogVlmForConditionalGenerationIntegrationTest(unittest.TestCase):
    def setUp(self):
        self.processor = AutoProcessor.from_pretrained("cogvlm-hf/bakCogVlm-v1-hf")
    ...
    def test_small_model_integration_test(self):
        ...
        model = CogVlmForConditionalGeneration.from_pretrained("cogvlm-hf/bakCogVlm-v1-hf", load_in_4bit=True)

        prompt = "<image>\nUSER: What are the things I should be cautious about when I visit this place?\nASSISTANT:"
        image_file = "https://cogvlm-vl.github.io/static/images/view.jpg"
    ...
    def test_small_model_integration_test_llama(self):
        # Let' s make sure we test the preprocessing to replace what is used
        model_id = "cogvlm-hf/cogvlm-1.5-7b-hf"

        model = CogVlmForConditionalGeneration.from_pretrained("cogvlm-hf/cogvlm-1.5-7b-hf", load_in_4bit=True)
    ...
    def test_small_model_integration_test_llama_batched(self):
        ...
        image1 = Image.open(requests.get("https://cogvlm-vl.github.io/static/images/view.jpg", stream=True).raw)
