...
_import_structure = {
    ...
    "tokenization_vqgan": ["VQGANTokenizer"],
}

if is_vision_available():
    _import_structure["feature_extraction_vqgan"] = ["VQGANFeatureExtractor"]
    _import_structure["processing_vqgan"] = ["VQGANProcessor"]
...
if is_flax_available():
    _import_structure["modeling_flax_vqgan"] = [
        "FlaxVQGANModel",
...
if TYPE_CHECKING:
    ...
    if is_vision_available():
        ...
        from .processing_vqgan import VQGANProcessor
    ...
    if is_flax_available():
        from .modeling_flax_vqgan import FlaxVQGANModel, FlaxVQGANPreTrainedModel
